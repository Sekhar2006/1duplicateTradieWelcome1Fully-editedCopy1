      ...
      <div className="max-w-4xl mx-auto mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm hidden sm:inline" style={{ color: '#003E6D' }}>Grading</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-500 hidden sm:inline">Lots</span>
          </div>
          <div className="flex-1 h-0.5 bg-gray-300 mx-1 sm:mx-2"></div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center flex-shrink-0">
            ...
            <span className="text-sm text-gray-500 hidden sm:inline">Tokenization</span>
          </div>
          <div className="flex-1 h-0.5 bg-gray-300 mx-1 sm:mx-2"></div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center flex-shrink-0">
            ...
            <span className="text-sm text-gray-500 hidden sm:inline">Verification</span>
          </div>
        </div>
      </div>
