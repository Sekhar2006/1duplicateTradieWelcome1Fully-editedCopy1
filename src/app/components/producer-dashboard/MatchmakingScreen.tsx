            ...
            <DSCard key={match.id} className="hover:shadow-lg transition-shadow">
              <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <DSButton variant="primary" className="w-full sm:flex-1 flex items-center justify-center gap-2">
                    <TrendingUp className="w-4 h-4" />
                    Propose Price
                  </DSButton>
                  <DSButton variant="outline" className="w-full sm:flex-1 flex items-center justify-center gap-2">
